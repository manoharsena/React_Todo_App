  ...
  return (
    <>
      <div className="container mt-md-3">
        <h4 className="text-center mt-2" id="tittle"
        style={{ color: "green" }}>
          My todo
        </h4>
        <form>
          {/* Input for Todo Task Name */}
          <div className="input-group mb-3">
            <input
              type="text"
              className="my-4 rounded-2 border-dark form-control"
              value={taskName}
            ...
            <input
              type="text"
              class=" mx-5 my-4 rounded-2 border-dark form-control"
            ...
            {/* Add Todo Button */}
            <button
              class="btn p-3 btn-primary border-dark px-5 my-4 rounded-3"
              style={{ background: "#43b59a", fontWeight:"bolder" }}
              onClick={addTodo}
            >
        ...
        <div className="input-group">
          <h4 style={{ color: "#eb1038" }}>My ToDos</h4>

          <div className="ms-auto">
            <label htmlFor="filter">
              <h4 style={{ color: "#eb1038" }}>Status Filter : </h4>
            </label>
            <select
              className="mx-2 text-white rounded-2 bg-yellow"
              style={{ background: "#eda09f" }}
              value={filter}
              name="filter"
